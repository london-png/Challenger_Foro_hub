...
public class TopicoController {
    ...
    public ResponseEntity<Page<DatosListaTopico>> buscarPorFiltros(
        ...
        if (!anoStr.matches("\\d+")) {
            throw new ResponseStatusException(
                    BAD_REQUEST,
                    "El campo 'ano' debe contener solo números."
            );
        }
     ...
     //Este método NO incluye la solución asociada.
    ...
    public ResponseEntity<Page<DatosListaTopico>> listarTopicosConSolucion(
        ...
        Page<Topico> topicos = topicoRepository.findAllWithSolucion(
                Status.RESUELTO, //valida que el estado sea Resuelto
                paginacion
        );
    ...
    public ResponseEntity<ErrorResponse> handleResponseStatusException(ResponseStatusException ex) {
     ...
     // Clase de respuesta de error para estandarizar
